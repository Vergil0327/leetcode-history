...
For a fixed chosen value x, every other element not co-prime with x must be changed.

</details>
<details>
<summary>Hint 2</summary>

Precompute how many numbers in nums are divisible by each value, then use inclusion-exclusion over the prime factors of x to count elements sharing a common factor with x.

</details>
<details>
<summary>Hint 3</summary>

Try all possible selected values: existing values in nums, and values up to maxVal that can be created by changing the selected element.
