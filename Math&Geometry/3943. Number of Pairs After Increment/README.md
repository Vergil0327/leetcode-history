...
Think of nums1 as fixed. Precompute its frequency map once. For nums2, range additions make direct frequency maintenance hard, so split nums2 into sqrt-sized blocks.

</details>
<details>
<summary>Hint 2</summary>

For each block, keep: a lazy add value for the whole block, a frequency map of the block values before applying lazy.

</details>
<details>
<summary>Hint 3</summary>

For an update [x, y, val], fully covered blocks only increase their lazy value. Partially covered blocks are pushed/rebuilt manually.

</details>
<details>
<summary>Hint 4</summary>

For a query tot, for every distinct value a in nums1, count how many values equal tot - a in nums2 by checking each block’s frequency map after adjusting for lazy.
