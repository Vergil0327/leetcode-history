...
Each x maps to one component and each y maps to one component. Adding (x0, y0) connects at most two distinct components; activated = size(A) + size(B) + 1 (if same component then size(A) + 1).

</details>
<details>
<summary>Hint 4</summary>

Maximize by choosing the two components with largest size; if only one component, answer = n + 1.
