...
A streak of length L earns L * (L + 1) / 2 points. An optimal schedule has exactly one skipped day between consecutive streaks.
</details>

<details>
<summary>Hint 2</summary>
Temporarily charge each streak L + 1 days, including a skipped day after it. Use dynamic programming over the total score, treating each streak length as a reusable option with this cost.
</details>

<details>
<summary>Hint 3</summary>
Subtract one from the result because no skipped day is needed after the final streak. Only O(sqrt(n)) streak lengths need to be considered.
</details>