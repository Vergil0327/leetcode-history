...
Let dp[c][i] be the maximum sum using at most c subarrays among the first i elements.

</details>
<details>
<summary>Hint 2</summary>

A subarray ending at i and starting at j contributes prefix[i] - prefix[j], where l <= i - j <= r.

</details>
<details>
<summary>Hint 3</summary>

Rewrite the transition as prefix[i] + max(dp[c - 1][j] - prefix[j]), and maintain this maximum with a deque.
