...
Use tree DP. Let dp0[u][r] mean node u is not selected, and dp1[u][r] mean node u is selected, with subtree sum modulo k equal to r.

</details>
<details>
<summary>Hint 2</summary>

Initialize dp0[u][0] = 1 and dp1[u][nums[u] % k] = 1. When merging child v: if u is selected, merge only with dp0[v]; otherwise merge with dp0[v] + dp1[v].
