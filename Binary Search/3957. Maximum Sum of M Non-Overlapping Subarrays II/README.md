...
Instead of directly limiting the number of selected subarrays, assign a penalty x for choosing each subarray.

</details>
<details>
<summary>Hint 3</summary>

For a fixed penalty x, maximize the adjusted value sum - x * count, while also tracking how many subarrays are chosen.

</details>
<details>
<summary>Hint 4</summary>

For each fixed penalty, use a deque to optimize transitions over previous split points whose distance is between l and r.

</details>
<details>
<summary>Hint 5</summary>

As x increases, the optimal number of selected subarrays decreases, so binary search the penalty.
