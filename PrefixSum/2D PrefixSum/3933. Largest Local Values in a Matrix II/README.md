...
Brute forcing every centered square can be too slow: each check may scan up to 200 * 200 cells.

</details>
<details>
<summary>Hint 2</summary>

Since all values are at most 200, build prefix sums by threshold: for each v, store how many cells have value > v in every prefix rectangle.

</details>
<details>
<summary>Hint 3</summary>

For a cell with value x, query its clamped square using the prefix sum for threshold x. If the count of values > x is zero, it is a local maximum.

</details>
<details>
<summary>Hint 4</summary>

Remember to subtract the ignored corner cells (i ± x, j ± x) from the queried count if they are inside the matrix and greater than x.
