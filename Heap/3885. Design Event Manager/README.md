...
In pollHighest, keep popping until the top matches the live priority stored in the map.

</details>
<details>
<summary>Hint 3</summary>

Use {priority, -eventId} ordering so the max-heap returns the highest priority first and the smallest eventId on ties.
